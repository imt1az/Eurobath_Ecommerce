...
class SubCategoryController extends Controller
{
    ...
    public function SubCategoryStore(Request $request)
    {
        $request->validate([
            ...
            'category_id.required' => 'Input Category English Name',
            'subcategory_name_en.required' => 'Input Category Hindi Name',
        ]);
    ...
    public function SubSubCategoryStore(Request $request)
    {
        ...
        $request->validate([
            ...
            'category_id.required' => 'Input Category English Name',
            'subsubcategory_name_en.required' => 'Input Sub-SubCategory Hindi Name',
        ]);
