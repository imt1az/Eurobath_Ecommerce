...
//            'digital_file' => $digitalItem,
    ...
    public function EditProduct($id)
    {
        ...
        $subsubcategorie = SubSubCategory::latest()->get();
        $products = Product::findOrFail($id);

        return view('backend.product.product_edit',compact('categories','brands','subcategorie','subsubcategorie','products','multiImgs'));
    }
...
//Thumbnail Image Update
    ...
    public function ProductDetaile($id)
    {
        ...
        return view('backend.product.product_detaile',compact('categories','brands','subcategorie','subsubcategorie','products','multiImgs'));
