...
class BlogController extends Controller
{
    ...
    public function BlogCategoryStore(Request $request)
    {
        $request->validate([
            ...
            'blog_category_name_hin.required' => 'Input Category Bangla Name',
        ]);
    ...
    public function BlogPostStore(Request $request){
        $request->validate([
            ...
            [
                'post_title_en.required'=> 'Input Post Name English',
                'post_title_hin.required'=> 'Input Post Name Bangla',
                'post_image.required'=> 'Input Post Image',
            ]);
        ...
        BlogPost::insert([
            ...
            'post_slug_hin' =>strtolower(str_replace(' ','-',$request->post_slug_hin)),
            'post_image' =>$save_url,
