                        ...
                        <div class="col">
                            <form method="post" action="{{route('post-store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor1" required="" name="post_details_en"
                                                                  rows="10" cols="80">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor2" required="" name="post_details_hin"
                                                                  rows="10" cols="80">
												Post Details Bangla</textarea>
                                ...
                                <div class="text-xs-right">
                                    <input type="submit" class="btn btn-warning mb-5" value="Add Post">
                                </div>
                            </form>
