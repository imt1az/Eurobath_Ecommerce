                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>Admin User Picture<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-6">
                                                <img id="showImage"
                                                     src="{{ url($adminuser->profile_photo_path)}}" style="width: 100px; height: 100px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_12" name="orders" {{$adminuser->orders==1 ? 'checked':''}}
                                                                   value="1">
                                                            <label for="checkbox_12">Orders</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_13" name="stock" {{$adminuser->stock==1 ? 'checked':''}}
                                                                   value="1">
                                                            <label for="checkbox_13">Stock</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_14" name="reports" {{$adminuser->reports==1 ? 'checked':''}}
                                                                   value="1">
                                                            <label for="checkbox_14">Reports</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_15" name="alluser" {{$adminuser->alluser==1 ? 'checked':''}}
                                                                   value="1">
                                                            <label for="checkbox_15">Alluser</label>
                                                        </fieldset>

                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_16" name="adminuserrole" {{$adminuser->adminuserrole==1 ? 'checked':''}}
                                                                   value="1">
                                        ...
                                        <div class="text-xs-right">
                                            <input type="submit" class="btn btn-warning mb-5" value="Update Admin User">
                                        </div>
                            </form>
