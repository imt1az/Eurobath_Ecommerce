                                    ...
                                    @foreach($sliders as $item)
                                        <tr>
                                            ...
                                            <td width="30%">
                                                ...
                                                @if($item->status==1)
                                                    <a href="{{route('slider.inactive',$item->id)}}" class="btn btn-danger"><i class="fa fa-arrow-down" title="product detailes data"></i></a>
                                                @else
                                                    <a href="{{route('slider.active',$item->id)}}" class="btn btn-success"><i class="fa fa-arrow-up" title="product detailes data"></i></a>
                                                @endif
                                            </td>
