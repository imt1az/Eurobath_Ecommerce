...
{{--                                            </div>--}}
                               ...
                               {{-- Add Color and Product Size--}}
                                    ...
                                    <!-- /.row -->
                               {{--End Add Color and Product Size--}}
                                    ...
                                    <div class="quantity-container info-container">
                                        <div class="row">
                                            ...
                                            {{--ADD To Cart With Ajas Model Start--}}
                                        ...
                                        <div class="product-tab">
                                                ...
                                                <div class="reviews">
                                                    @foreach($reviews as $item)
                                                        ...
                                                        <div class="review">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <img style="border-radius: 50%" src="{{(!empty($item->user->profile_photo_path)) ? url('upload/user_images/'.$item->user->profile_photo_path): url('upload/avatar.png')}}"
                                                                         width="40px;" height="40px;"><b style="margin-left: 10px;">{{$item->user->name}}</b>
                                                                    @if($item->rating == NULL)
                                                        ...
                                                        <div class="review-title"><span class="summary">{{$item->summary}}</span><span
                                                                class="date"><i class="fa fa-calendar"></i><span>{{\Carbon\Carbon::parse($item->created_at)->diffForHumans()}}</span></span>
                                                        </div>
                                            ...
                                            <div class="product-add-review">
                                                ...
                                                <div class="review-form">
                                                    @guest
                                                        <p><b>For add product review,you need to login first! <a href="{{route('login')}}"style="color: red">Login in here</a></b></p>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control txt" name="summary"
                                                                                placeholder="">
                                                                    </div><!-- /.form-group -->
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputReview">Review <span
                                                                                class="astk">*</span></label>
                                                                        <textarea class="form-control txt txt-review" name="comment"
                                                                                   rows="4"
...
{{--                @include('frontend.body.brands')--}}
    ...
    <!-- Go to www.addthis.com/dashboard to customize your tools -->
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-611d69d3628c6b8d"></script>
