        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class='col-md-9'>
                    ...
                    @foreach($breasusubbcat as $item)
                        <span class="badge badge-success" style="background: #0f6cb2">{{$item->category->category_name_en}}</span>
                    @endforeach
                    /
                    @foreach($breasusubbcat as $item)
                        <span class="badge badge-success" style="background: #ee1044">{{$item->subcategory->subcategory_name_en}}</span>
                    @endforeach
                    /
                    @foreach($breasusubbcat as $item)
                        <span class="badge badge-success" style="background: #e83e8c">{{$item->subsubcategory_name_en}}</span>
                    @endforeach
