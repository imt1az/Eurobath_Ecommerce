...
{{--                            <div class="home-banner"><img src="assets/images/banners/LHS-banner.jpg" alt="Image"></div>--}}
                ...
                <div class='col-md-9'>
                   ...
                   @include('frontend.common.banner.InnerBanner')
                    ...
                    /
                    @foreach($breasubcat as $item)
                        <span class="badge badge-success" style="background: #ee1044">{{$item->subcategory_name_en}}</span>
                    @endforeach
                        ...
                        <div id="myTabContent" class="tab-content category-list">
                            <div class="tab-pane active " id="grid-container">
                                <div class="category-product">
                                    <div class="row" id="grid_list_product">
    ...
    <script>
        function loadmoreProduct(page){
            ...
            .done(function (data) {
                ...
                $('#grid_list_product').append(data.grid_view);
